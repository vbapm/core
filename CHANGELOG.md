...
### Added
- Multilingual support: Encoding detection and conversion for VBA source files across Windows ANSI codepages (CP874, CP932, CP936, CP949, CP950, CP1250–CP1258). Supported via `iconv-lite`. ([#103])
