...
However, since the XML data file generated by Office (Excel, Word and PoewrPoint) can be very large. It may cause memory errors and performance issues in vscode-xml, which uses a Java-based language server. If you want to use vscode-xml, you can follow the guide below to avoid memory related errors:
